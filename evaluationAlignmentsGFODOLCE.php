...
session_start();
			...
			$line = $_SESSION['participantName'].",".$_SESSION['participantEmail'].",".$_SESSION['participantWhichFOs'].",".$_SESSION['participantOtherFOs'].",".$_SESSION['participantFamLev'].",".$_POST['a1'].",".$_POST['a2'].",".$_POST['a3'].",".$_POST['a4'].",".$_POST['a5'].",".$_POST['a6'].",".$_POST['a7'].",".$_POST['a8'].",".$_POST['a9'].",".$_POST['a10'].",".$_POST['a11'].",".$_POST['a12'].",".$_POST['a13'].",".$_POST['a14'].",".$_POST['a15'].",".$_POST['a16'].",".$_POST['a17'].",".$_POST['a18'].",".$_POST['a19'].",".$_POST['a20'].",".$_POST['a21'].",".$_POST['a22'].",".$_POST['a23'].",".$_POST['a24'].",".$v;
			
			$line2= "\n";
			
			$handle = fopen("user-input/GFODOLCEAlignmentsEval.csv", "a+");
			//fwrite($handle,$line2);
			fwrite($handle,$line);
			fwrite($handle,$line2);
...
<li class="current"><a href="evaluation.html">Evaluate ROMULUS</a>
            <ul class="sub-menu">
                    ...
                    <li class = "current"><a href ="evaluationAlignmentsGFODOLCE.html">GFO - DOLCE</a></li>
