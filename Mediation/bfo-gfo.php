...
(SELECT `MediationID` from `Mediation` where `MediationSETID` =1))";
...
echo "<h5><a href = MediationMetadata/bfo-gfo-metadata.php> Metadata for alignments between " .$ontoname[0]." and ".$ontoname[1]." </a> </h5>";
...
$query = "SELECT `MediationID`, `MediationRelation`, `MediationMappable` from `Mediation` where `MediationSetID` = 1";
