...
(SELECT `MediationID` from `Mediation` where `MediationSETID` =18))";
...
$query = "SELECT `MediationID`, `MediationRelation`, `MediationMappable` from `Mediation` where `MediationSetID` = 18";
