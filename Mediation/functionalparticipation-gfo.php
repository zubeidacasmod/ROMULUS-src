...
(SELECT `MediationID` from `Mediation` where `MediationSETID` =15))";
...
echo "<h5><a href = MediationMetadata/functionalparticipation-gfo-metadata.php> Metadata for alignments between " .$ontoname[0]." and ".$ontoname[1]." </a> </h5>";
...
$query = "SELECT `MediationID`, `MediationRelation`, `MediationMappable` from `Mediation` where `MediationSetID` = 15";
...
?>
		...
		<footer class="entry-meta">
            ...
            Edited on <time class="entry-date" datetime="2012-12-01" pubdate>December 01 2012</time>
