...
(SELECT `MediationID` from `Mediation` where `MediationSETID` =7))";
...
echo "<h5><a href = MediationMetadata/bforo-spatialrelations-metadata.php> Metadata for alignments between " .$ontoname[0]." and ".$ontoname[1]." </a> </h5>";
...
$query = "SELECT `MediationID`, `MediationRelation`, `MediationMappable` from `Mediation` where `MediationSetID` = 7";
