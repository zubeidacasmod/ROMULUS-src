...
(SELECT `MediationID` from `Mediation` where `MediationSETID` =17))";
...
echo "<h5><a href = MediationMetadata/temporalrelations-gfo-metadata.php> Metadata for alignments between " .$ontoname[0]." and ".$ontoname[1]." </a> </h5>";
...
$query = "SELECT `MediationID`, `MediationRelation`, `MediationMappable` from `Mediation` where `MediationSetID` = 17";
