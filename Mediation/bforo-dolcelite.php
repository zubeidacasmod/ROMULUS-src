...
(SELECT `MediationID` from `Mediation` where `MediationSETID` =3))";
...
echo "<h5><a href = MediationMetadata/bforo-dolcelite-metadata.php> Metadata for alignments between " .$ontoname[0]." and ".$ontoname[1]." </a> </h5>";
...
$query = "SELECT `MediationID`, `MediationRelation`, `MediationMappable` from `Mediation` where `MediationSetID` = 3";
