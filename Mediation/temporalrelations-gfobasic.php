...
(SELECT `MediationID` from `Mediation` where `MediationSETID` =20))";
...
echo "<h5><a href = MediationMetadata/temporalrelations-gfobasic-metadata.php> Metadata for alignments between " .$ontoname[0]." and ".$ontoname[1]." </a> </h5>";
...
$query = "SELECT `MediationID`, `MediationRelation`, `MediationMappable` from `Mediation` where `MediationSetID` = 20";
