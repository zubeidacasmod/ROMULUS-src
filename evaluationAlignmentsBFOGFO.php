...
session_start();
			...
			$line = $_SESSION['participantName'].",".$_SESSION['participantEmail'].",".$_SESSION['participantWhichFOs'].",".$_SESSION['participantOtherFOs'].",".$_SESSION['participantFamLev'].",".$_POST['a1'].",".$_POST['a2'].",".$_POST['a3'].",".$_POST['a4'].",".$_POST['a5'].",".$_POST['a6'].",".$_POST['a7'].",".$_POST['a8'].",".$_POST['a9'].",".$_POST['a10'].",".$_POST['a11'].",".$_POST['a12'].",".$_POST['a13'].",".$_POST['a14'].",".$v;
			
			$line2= "\n";
			
			$handle = fopen("user-input/BFOGFOAlignmentsEval.csv", "a+");
			//fwrite($handle,$line2);
			fwrite($handle,$line);
			fwrite($handle,$line2);
...
<li><a href="communitySubmission.html">Community</a></li>
            ...
            <ul class="sub-menu">
                    ...
                    <li class = "current"><a href ="evaluationAlignmentsBFOGFO.html">BFO - GFO</a></li>                    
                    </ul> <!-- Close d-b ul-->
...
<h3><a href = "evaluationAlignmentsDOLCEBFO.html">1. Evaluate alignments between DOLCE and BFO </a></h3>
