...
session_start();
	...
	if (empty($_POST['metadataExplain'])){
		...
		$varThreeOneOne = str_replace(",",";",$varThreeOneOne);
              $varThreeOneOne = str_replace(array("\r\n", "\r", "\n"), " newline ", $varThreeOneOne);
	...
	$varThreeTwoOne= str_replace(array("\r\n", "\r", "\n"), " newline ", $varThreeTwoOne);
	}
	...
	$varFourOne = "No answer";
		...
		$varFourOneOne = str_replace(",",";",$varFourOneOne);
              $varFourOneOne= str_replace(array("\r\n", "\r", "\n"), " newline ", $varFourOneOne);
	}
		...
		$varFourTwoOne= str_replace(array("\r\n", "\r", "\n"), " newline ", $varFourTwoOne);
	}
		...
		$varFourThree= str_replace(array("\r\n", "\r", "\n"), " newline ", $varFourThree);
	}
		...
		$varFourThreeOne = str_replace(",",";",$varFourThreeOne);
              $varFourThreeOne= str_replace(array("\r\n", "\r", "\n"), " newline ", $varFourThreeOne);
	}
	...
	if (empty($_POST['otherFOExplain'])){
		...
		$varFiveOneOne= str_replace(array("\r\n", "\r", "\n"), " newline ", $varFiveOneOne);
	}
